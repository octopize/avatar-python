...
- `User guide <#user-guide>`__
  ...
  - `How to have advice on parameters and
    processors <#how-to-have-advice-on-parameters-and-processors>`__
  ...
  - `How to view all jobs <#how-to-view-all-jobs>`__
  - `How to cancel a job <#how-to-cancel-a-job>`__
...
You can have recommendations on which parameters and processors to use
in the avatarization.
...
tutorial on time
series <https://github.com/octopize/avatar-python/blob/main/notebooks/Tutorial7-Time_series.ipynb>`__
...
A job can be cancelled. This is useful to manage the queue of jobs
created and avoid creation of unnecessary long queues.
