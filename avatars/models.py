...
#   filename:  <stdin>
#   timestamp: 2022-12-20T15:24:30+00:00
...
class PrivacyMetrics(BaseModel):
    ...
    direct_match_protection: float = Field(..., title="Direct Match Protection")
    ...
    inference_smape: Optional[float] = Field(None, title="Inference Smape")
    inference_accuracy: Optional[float] = Field(None, title="Inference Accuracy")
