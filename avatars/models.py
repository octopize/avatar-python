...
#   filename:  <stdin>
#   timestamp: 2023-09-12T13:41:32+00:00
...
class DatasetSummary(BaseModel):
    ...
    probable_ids: List[str] = Field(..., title="Probable Ids")
...
class PrivacyMetricsTimeSeriesParameters(BaseModel):
    ...
    unshuffled_avatar_dataset_id: UUID = Field(
        ..., title="Unshuffled Avatar Dataset Id"
    )
    projection_parameters: Optional[FPCAParameters] = Field(
        None,
...
class SignalMetricsTimeSeriesParameters(BaseModel):
    dataset_id: UUID = Field(..., title="Dataset Id")
    avatar_dataset_id: UUID = Field(..., title="Avatar Dataset Id")
...
class SignalMetricsWithTimeSeriesParameters(BaseModel):
    ...
    vanilla: SignalMetricsParameters = Field(
        ...,
        description="Vanilla parameters of the signal metrics. It contains the parameters for the computation of the dataset where a unique row is related to a unique individual. ",
        title="Vanilla",
    )
    time_series: List[SignalMetricsTimeSeriesParameters] = Field(
        ...,
        description="Signal metrics parameters of the time series. Each time series can have a different set of parameters.",
        title="Time Series",
    )


class TimeSeriesSignalMetricsPerDataset(BaseModel):
    pointwise_hellinger_mean: float = Field(..., title="Pointwise Hellinger Mean")
    pointwise_hellinger_std: float = Field(..., title="Pointwise Hellinger Std")
    density_hellinger_mean: float = Field(..., title="Density Hellinger Mean")
    density_hellinger_std: float = Field(..., title="Density Hellinger Std")
    original_id: UUID = Field(..., title="Original Id")
    avatars_id: UUID = Field(..., title="Avatars Id")
...
class AvatarizationTimeSeriesParameters(BaseModel):
    ...
    projection_parameters: FPCAParameters = Field(
        ...,
        description="Parameters of the time series projection.",
        title="Projection Parameters",
    )
...
class PrivacyMetricsBaseParameters(BaseModel):
    ...
    known_variables: Optional[List[str]] = Field(
        None,
...
class PrivacyMetricsParameters(BaseModel):
    """
    See :class:`PrivacyMetricsBaseParameters` and :class:`MetricsParameters`.
    """
...
class PrivacyMetricsWithTimeSeriesParameters(BaseModel):
    ...
    vanilla: PrivacyMetricsParameters = Field(
        ...,
        description="Vanilla parameters of the privacy metrics. It contains the parameters for the computation of the dataset where a unique row is related to a unique individual. ",
        title="Vanilla",
    )
    time_series: List[PrivacyMetricsTimeSeriesParameters] = Field(
        ...,
...
class TimeSeriesResult(BaseModel):
    ...
    sensitive_unshuffled_avatars_dataset: Dataset
...
class AvatarizationParameters(BaseModel):
    ...
    exclude_categorical: Optional[ExcludeCategoricalParameters] = None
    dataset_id: Optional[UUID] = Field(None, title="Dataset Id")
...
class AvatarizationWithTimeSeriesParameters(BaseModel):
    ...
    vanilla: AvatarizationParameters = Field(
        ...,
        description="General parameters of the anonymization. It contains the parameters for the anonymization of the dataset where a unique row is related to a unique individual. ",
        title="Vanilla",
    )
    time_series: List[AvatarizationTimeSeriesParameters] = Field(
        ...,
...
class AvatarizationWithTimeSeriesResult(BaseModel):
    individual_centric: Optional[AvatarizationResult] = None
    time_series_datasets: List[TimeSeriesResult] = Field(
        ..., title="Time Series Datasets"
    )


class MetaPrivacyMetrics(BaseModel):
    details: List[PrivacyMetricsPerDataset] = Field(..., title="Details")


class MetaSignalMetrics(BaseModel):
    details: List[
        Union[SignalMetricsPerDataset, TimeSeriesSignalMetricsPerDataset]
    ] = Field(..., title="Details")
