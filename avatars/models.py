...
# API Version : 0.5.13-6b4882eb9fadb0d44c78744c019e21290b7f90b9
...
#   filename:  <stdin>
#   timestamp: 2023-09-21T09:26:35+00:00
...
class PrivacyMetrics(BaseModel):
    ...
    distance_to_closest: Optional[float] = Field(None, title="Distance To Closest")
    closest_distances_ratio: Optional[float] = Field(
        None, title="Closest Distances Ratio"
    )
...
class AvatarizationWithTimeSeriesParameters(BaseModel):
    ...
    exclude_categorical: Optional[ExcludeCategoricalParameters] = None
    vanilla_dataset_id: Optional[UUID] = Field(
        None,
...
class AvatarizationWithTimeSeriesResult(BaseModel):
    datasets: List[AvatarizationResultPerDataset] = Field(..., title="Datasets")
