...
#   filename:  input.json
#   timestamp: 2024-02-05T14:45:16+00:00
...
class GeolocationPrivacyMetrics(BaseModel):
    ...
    inference_features: Annotated[
        Optional[float], Field(title="Inference Features")
    ] = None
    correlation_protection_rate_features: Annotated[
        Optional[float], Field(title="Correlation Protection Rate Features")
    ] = None
...
class PrivacyMetricsGeolocationParameters(BaseModel):
    ...
    projection_parameters: Annotated[
        Optional[GeolocationFeaturesParameters],
...
class PrivacyMetricsGeolocationJob(BaseModel):
    ...
    error_message: Annotated[Optional[str], Field(title="Error Message")] = None
    traceback: Annotated[Optional[str], Field(title="Traceback")] = None
    result: Optional[GeolocationPrivacyMetrics] = None
...
class TableLink(BaseModel):
    ...
    child_link_key: Annotated[
        str,
        Field(
            description="Variable to be used for linking with the parent table. It is most often a foreign key. It needs to have the type ColumnType.IDENTIFIER when\n        creating the dataset.",
...
class PrivacyMetricsMultiTableParameters(BaseModel):
    ...
    table_parameters: Annotated[
        List[Union[PrivacyMetricsParameters, PrivacyMetricsWithTimeSeriesParameters]],
        Field(
...
class AvatarizationMultiTableParameters(BaseModel):
    ...
    table_parameters: Annotated[
        List[Union[AvatarizationParameters, AvatarizationWithTimeSeriesParameters]],
        Field(
