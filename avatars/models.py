...
#   filename:  <stdin>
#   timestamp: 2022-09-23T09:57:44+00:00
...
class AvatarizationParameters(BaseModel):
    ...
    dataset_id: Optional[UUID] = Field(
        None,
        description="Mandatory, except when using deprecated JobCreate.",
        title="Dataset Id",
    )
...
class AvatarizationResultResponse(BaseModel):
    ...
    sensitive_unshuffled_avatars_dataset: DatasetResponse
...
class JobCreate(BaseModel):
    ...
    dataset_id: UUID = Field(
        ...,
        description="Deprecated. Use AvatarizationJobCreate with dataset_id in AvatarizationParameters.",
        title="Dataset Id",
    )
    parameters: AvatarizationParameters
